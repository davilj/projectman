...
<div dojoType="dijit.TitlePane" style="width: 100%" title="Create New Managed Fund Product">
    <form:form action="/ProjectManager/product/managedFund" method="POST" modelAttribute="managedFund">
		<div>
...
<div dojoType="dijit.TitlePane" style="width: 100%" title="Create New Loan Product">
    <form:form action="/ProjectManager/product/loan" method="POST" modelAttribute="loan">
		<div>
...
<div dojoType="dijit.TitlePane" style="width: 100%" title="Create New Cash Product">
    <form:form action="/ProjectManager/product/cash" method="POST" modelAttribute="cash">
		<div>
